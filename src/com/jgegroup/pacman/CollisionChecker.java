...
public class CollisionChecker {
  ...
  public boolean isValidDirection(Entity entity, Direction direction) {
    ...
    int entity_left_col = entity_left_worldX / GameScene.TILE_SIZE;
    int entity_right_col = entity_right_worldX / GameScene.TILE_SIZE;
    int entity_top_row = entity_top_worldY / GameScene.TILE_SIZE;
    int entity_bottom_row = entity_bottom_worldY / GameScene.TILE_SIZE;

    int tileNum1, tileNum2;

    switch (direction) {
      case UP:
        entity_top_row = (entity_top_worldY - entity.speed) / GameScene.TILE_SIZE;
        ...
        break;
      case DOWN:
        entity_bottom_row = (entity_bottom_worldY + entity.speed) / GameScene.TILE_SIZE;
        ...
        break;
      case LEFT:
        entity_left_col = (entity_left_worldX - entity.speed) / GameScene.TILE_SIZE;
        tileNum1 = map.mapArray2D[entity_left_col][entity_top_row];
        ...
        break;
      case RIGHT:
        entity_right_col = (entity_right_worldX + entity.speed) / GameScene.TILE_SIZE;
